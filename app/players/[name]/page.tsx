import { getPlayerStats, getPlacementDistribution, getPlayerHistory, getLatestSnapshot } from '@/lib/queries'
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            {snapshot.current_rank !== null && (
              <p className="text-gray-400 text-sm mt-1">Rank #{snapshot.current_rank}</p>
            )}
          </div>
          <WindowSelector current={window} />
        </div>
        <p className="text-gray-500 text-sm mb-6">No games tracked in this window.</p>
